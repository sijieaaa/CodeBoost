...
def upload_model_to_huggingface(local_path: str, remote_path: str):
    ...
    if api.repo_exists(repo_id=remote_path):
        print(f"Repo {remote_path} already exists, deleting it...")
        api.delete_repo(repo_id=remote_path, missing_ok=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hf_upload_path", default=False, type=str, help="The path of the hf repo to upload")
    args = parser.parse_args()
    local_dir: str = args.local_dir

    assert not local_dir.endswith("hf"), "The local_dir should not end with hf."
    ...
    hf_path = os.path.join(local_dir, "hf")
    ...
    if args.hf_upload_path:
        print(f"Uploading model to Hugging Face at {args.hf_upload_path}...")
