...
class SequentialFunctionRewardManager(FunctionRewardManager):
    ...
    def compute_reward(self, data: DataProto, ppo_config=None) -> Tuple[torch.Tensor, Dict[str, List[float]]]:
        # breakpoint()
        ...
        for i in range(len(data)):
            ...
            # -- add miscinfo_dict
            miscinfo_dict = data.non_tensor_batch["miscinfo_dict"][i]

            score = self.reward_fn(response_str, ground_truth, 
                                   miscinfo_dicts=miscinfo_dict,
...
class BatchFunctionRewardManager(FunctionRewardManager):
    ...
    def compute_reward(self, data: DataProto, ppo_config=None) -> Tuple[torch.Tensor, Dict[str, List[float]]]:
        ...
        for i in range(len(data)):
            ...
            # -- add miscinfo_dict
            miscinfo_dict.append(data.non_tensor_batch["miscinfo_dict"][i])
